...
var selfreload = require('self-reload-json');
var config = new SelfReloadJSON("static/saved_model/vgg16flask.json");
console.log("before");
console.log(config);
console.log("after");

setInterval(function(){$.getJSON("static/saved_model/vgg16flask.json",function(json) {
    console.log("wouhou3!");
    console.log(json);
